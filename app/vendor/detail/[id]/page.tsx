    ...
    <div className="bg-white">
      ...
      {loadingVendor ? (
        ...
        <div>
          ...
          {/* <div className="flex flex-col my-10 text-xl justify-center items-center bg-white">
            ...
            <div className="relative mt-16 w-full max-w-[270px] md:max-w-[750px] lg:max-w-[1020px] flex items-center">
              ...
              <div className="overflow-hidden w-full">
                <div
                  className="flex transition-transform duration-300 gap-"
                  style={{
                ...
                >
                  {selectedDetailVendor?.packages?.map((item, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 rounded-lg flex-col mb-4 border shadow-lg cursor-pointer w-[250px] lg:w-[300px] hover:bg-secondary2"
          ...
          {selectedDetailVendor?.packages?.length > 0 && (
            <div className="mx-auto max-w-[1060px] mt-12 h-40 rounded-lg">
              <SliderPackage
                dataPackage={selectedDetailVendor?.packages}
