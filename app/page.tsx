	...
	return (
		<div className='md:mx-16'>
			<UpReveal>
				<div className="bg-[url('/banner/bg-1.png')] bg-no-repeat bg-center bg-cover rounded-lg shadow-md h-52 text-white flex items-center justify-between grid-cols-2">
					<div className='pe-12 p-12 lg:p-28 font-bold text-lg lg:text-2xl'>
						...
						<span className='absolute lg:ms-4 ms-2 text-center'>
							<UpRevealWord words={["Greatest", "Awesome", "Perfect"]} />
						</span>
					...
					{explains?.map((item, i) => {
						...
						return (
							<div
								...
								key={i}>
								<div
									className={`${gapDiv} ${i % 2 != 0 ? "md:order-last" : ""}`}>
									<img
				...
				<div className='bg-gray-200 my-3 xl:mx-24 sm:mx-auto shadow text-center text-md md:text-lg lg:text-2xl py-8 overflow-hidden rounded-lg shadow-lg p-8 px-32'>
				...
				<div className='bg-[#985D2B] text-white px-16 pt-3 pb-0 shadow-lg rounded-t-lg'>
