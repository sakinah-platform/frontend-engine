...
export const Footer = () => {
  return (
    <div className="h-full py-28 z-100">
      <footer
        role="contentinfo"
        className="bg-primary2 text-white md:px-32 px-16 fixed bottom-0 left-0 w-full pt-3 pb-2 shadow-lg rounded-t-2xl shadow-lg"
      >
